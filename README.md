...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/base.css"
      media="all"
    />
  </head>
  <body>
    ...
    <!-- logic -->
    <script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/index.js"></script>
    <!-- modules -->
  </body>
</html>
```
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/carousel-player/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/timer-countdown/index.js"></script>
...
<link
  rel="stylesheet"
  href="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/speaker-video/styles.css"
  media="all"
/>
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/speaker-video/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/random-selection/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/b0328e0/modules/qr-code/index.js"></script>
