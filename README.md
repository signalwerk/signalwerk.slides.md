...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/base.css"
      media="all"
    />
  </head>
  <body>
    ...
    <!-- logic -->
    <script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/index.js"></script>
    <!-- modules -->
  </body>
</html>
```
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/carousel-player/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/timer-countdown/index.js"></script>
...
<link
  rel="stylesheet"
  href="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/speaker-video/styles.css"
  media="all"
/>
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/speaker-video/index.js"></script>
...
```html
<script
  src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/pekachuta-presentation/index.js"
  defer
></script>
```
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/image-player/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/random-selection/index.js"></script>
...
```html
<script src="https://rawcdn.githack.com/signalwerk/signalwerk.slides.md/abeeded/modules/qr-code/index.js"></script>
